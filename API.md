...
| List a peer's steps for us | `juice admin steps <user\|key>` — waiting steps that peer parked for this kernel, each with its action, `partial_args`, derived `allowed_input`, and age |
