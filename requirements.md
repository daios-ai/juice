...
`API.md` is a derivative interface reference; `ecosystem-standard.md` binds the programs beside the kernel (instances, client records, credential release); `README.md`, `ROADMAP.md`, and `docs/` are context. None is a competing contract, and this document governs on conflict.
