...
list:      JCS({counterparty, recipient, scope: "step_list", timestamp})
           → the serving kernel's waiting steps whose required_caller is the requesting peer,
             ...
             `next_offset`, which the requester follows until exhausted
