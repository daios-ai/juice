				...
				"results": map[string]any{
					...
					"items": map[string]any{
						...
						"properties": map[string]any{
							...
							"price":        map[string]any{"type": "integer", "description": "Action price in credits"},
							"uses":         map[string]any{"type": "integer", "description": "Total number of uses"},
							"failures":     map[string]any{"type": "integer", "description": "Total number of failures"},
						},
					},
				},
			},
