...
write_config() {
    local db="$1"; shift
    local fee_bps=0 script_timeout_ms=10000 kernel_handle="@test-kernel" make_max_steps=5 bootstrap_peers="" remote_retry_interval_seconds=60 discovery_interval_seconds=300
    local a
