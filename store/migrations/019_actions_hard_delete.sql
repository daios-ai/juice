-- Switch actions to hard-delete. action_name in transactions makes soft-delete unnecessary.
-- Rebuild actions without deleted_at; rebuild listeners with ON DELETE CASCADE on target_action_id.
